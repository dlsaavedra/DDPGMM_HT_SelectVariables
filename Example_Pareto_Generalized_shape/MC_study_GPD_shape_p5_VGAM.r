...
for (n in c(200, 400, 800)){
  ...
  for (iter_beta in 1:nrow(list_betas)){
    ...
    print(c(min(xi_true), max(xi_true)))
  }
  
  
  
  
  output_dir_AIC = paste0("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_AIC_n", n, "/")
  if (!dir.exists(output_dir_AIC)) dir.create(output_dir_AIC, recursive = TRUE)
  output_dir_BIC = paste0("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_BIC_n", n, "/")
...
for (n in c(200,400,800)){
  ...
  output_dir = paste0("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_AIC_n", n , "/")
  ...
  for (iter_beta in 1:nrow(list_betas)){
    ...
    for (iter_mc in 1:n_mc){
      ...
      load(file = file_path)
      vec = get_variable(modelo_final_AIC)
      if (is.null(vec)){
...
load("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_AIC_n200/Matrix_n200.Rdata")
matrix_result_n200 = matrix_result
load("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_AIC_n400/Matrix_n400.Rdata")
matrix_result_n400 = matrix_result
load("../Example_Pareto_Generalized_shape/MC_study_p5/MC_study_VGAM_AIC_n800/Matrix_n800.Rdata")
