...
load("../Example_Frechet_shape/MC_study_p5/MC_study_VGAM_AIC_n200/Matrix_n200.Rdata")
matrix_result_n200 = matrix_result
load("../Example_Frechet_shape/MC_study_p5/MC_study_VGAM_AIC_n400/Matrix_n400.Rdata")
matrix_result_n400 = matrix_result
load("../Example_Frechet_shape/MC_study_p5/MC_study_VGAM_AIC_n800/Matrix_n800.Rdata")
