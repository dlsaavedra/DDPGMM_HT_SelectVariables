...
output_dir =  "../Example_Frechet_shape/MC_study_p5/MC_study_n800/"
load(file = paste0(output_dir,"matrix_result_n800_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Frechet_shape/MC_study_p5/MC_study_n400/"
load(file = paste0(output_dir,"matrix_result_n400_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Frechet_shape/MC_study_p5/MC_study_n200/"
