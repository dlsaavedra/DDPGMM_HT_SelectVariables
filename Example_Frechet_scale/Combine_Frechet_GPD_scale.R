...
output_dir =  "../Example_Frechet_scale/MC_study_p5/MC_study_n800/"
load(file = paste0(output_dir,"matrix_result_n800_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Frechet_scale/MC_study_p5/MC_study_n400/"
load(file = paste0(output_dir,"matrix_result_n400_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Frechet_scale/MC_study_p5/MC_study_n200/"
...
output_dir =  "../Example_Pareto_Generalized_scale/MC_study_p5/MC_study_n800/"
load(file = paste0(output_dir,"matrix_result_n800_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Pareto_Generalized_scale/MC_study_p5/MC_study_n400/"
load(file = paste0(output_dir,"matrix_result_n400_prob_mean_2", ".Rdata"))
output_dir =  "../Example_Pareto_Generalized_scale/MC_study_p5/MC_study_n200/"
load(file = paste0(output_dir,"matrix_result_n200_prob_mean_2", ".Rdata"))
...
# Suponiendo que matrix_result_n200 y matrix_result_n400 son matrices ya cargadas
# Convertir ambas matrices a formato largo
df4 <- melt(matrix_result_n200_mean)
df5 <- melt(matrix_result_n400_mean)
df6 <- melt(matrix_result_n800_mean)

# Nombres para los ejes, como factores para mantener el orden
df4$Var1 <- factor(df1$Var1, levels = rev(rownames(matrix_result_n200_mean)))
df4$Var2 <- factor(df1$Var2, levels = colnames(matrix_result_n200_mean))

df5$Var1 <- factor(df2$Var1, levels = rev(rownames(matrix_result_n400_mean)))
df5$Var2 <- factor(df2$Var2, levels = colnames(matrix_result_n400_mean))

df6$Var1 <- factor(df3$Var1, levels = rev(rownames(matrix_result_n800_mean)))
df6$Var2 <- factor(df3$Var2, levels = colnames(matrix_result_n800_mean))
...
ggsave(filename = paste(path_save,"Combine_Pixel_plot", ".png", sep= ""), plot = final_plot,
