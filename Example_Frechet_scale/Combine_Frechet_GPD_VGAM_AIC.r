...
load("../Example_Frechet_scale//MC_study_p5/MC_study_VGAM_AIC_n200/Matrix_n200.Rdata")
matrix_result_n200 = matrix_result
load("../Example_Frechet_scale/MC_study_p5/MC_study_VGAM_AIC_n400/Matrix_n400.Rdata")
matrix_result_n400 = matrix_result
load("../Example_Frechet_scale/MC_study_p5/MC_study_VGAM_AIC_n800/Matrix_n800.Rdata")
...
ggsave(filename = paste(path_save,"Combine_Pixel_plot_VGAM_AIC", ".png", sep= ""), plot = final_plot,
