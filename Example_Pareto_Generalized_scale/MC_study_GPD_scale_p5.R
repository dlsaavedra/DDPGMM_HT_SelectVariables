...
for (n in c(200,400,800)){
  ...
  output_dir = paste0("../Example_Pareto_Generalized_scale/MC_study_p5/MC_study_n",n,"/")
...
#
#for (k in 1:dim(matrix_result_n200)[3]) {
...
#}
#save(matrix_result_max, file = paste0(output_dir,"matrix_result_n200_max", ".Rdata"))
