...
step_AIC_gpd <- function(dat, variables_iniciales = NULL){
...
step_BIC_gpd <- function(dat, variables_iniciales = NULL){
  # Todas las posibles variables predictoras
  todas <- colnames(dat)[colnames(dat) != "y"]
...
modelo1_final_AIC_gpd <- tryCatch(
  {
    step_AIC_gpd(dat = cbind(dat1, X))
  },
...
modelo1_final_BIC_gpd <- tryCatch(
  {
    step_BIC_gpd(dat = cbind(dat1, X))
  },
  # Bloque 'error': Se ejecuta si vglm falla
  error = function(e) {
    message("Se ha producido un error al ajustar el modelo vglm:")
...
# Código para ajustar el modelo
modelo2_final_AIC_gpd <- tryCatch(
  {
    step_AIC_gpd(dat = cbind(dat2, X))
  },
  # Bloque 'error': Se ejecuta si vglm falla
  error = function(e) {
    message("Se ha producido un error al ajustar el modelo vglm:")
...
modelo2_final_BIC_gpd <- tryCatch(
  {
    step_BIC_gpd(dat = cbind(dat2, X))
  },
  # Bloque 'error': Se ejecuta si vglm falla
  error = function(e) {
    message("Se ha producido un error al ajustar el modelo vglm:")
